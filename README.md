...
- So above 2 methods can  solve most of the problems. And in situations where the App is too big and complex in terms of managing the state. Redux comes to the rescue to simplify things.
